...
</br></br></br></br><span style='color:black; font-family:Impact,Charcoal,sans-serif; font-weight:bold; font-size:45px; '>Dinner Sets </span>
<hr align="left"/>
<?php 
	...
	$sql="SELECT * FROM  dinnersets WHERE subC='dnrp1'";
...
<div style='float:left;'><img src='$img' style='border-radius:30px;' width='250px' height='300px'/></div>
  ...
  <a href='mydinnerSets.php'>&laquo;</a>
  <a class='active' href='mydinnerSets.php'>1</a>
  <a  href='mydinnerSets2.php'>2</a>
  <a href='mydinnerSets2.php'>&raquo;</a>
</div>";
?>

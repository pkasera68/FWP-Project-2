...
<span style=' font-family:Verdana,sans-serif; color:Grey; font-size:16px;'>&nbsp&nbspDeliver To:</br>&nbsp&nbsp$adrr
</span>
</br></br>
...
<button type='submit' style=' margin-left:50px; width:590px; text-align:center;' name='buy' class='cart' value=''>Confirm Order</button>
</form>
</div>
</div>";
<?php
    ...
    exit;
		...
		$_SESSION["prt"]='knvandspoons';
?>
<html style="background-color: #EAEDED">
<head>
<title>
		Knives And spoons 1</title>
...
</br></br></br></br><span style='color:black; font-family:Impact,Charcoal,sans-serif; font-weight:bold; font-size:45px; '>Knives and Spoons</span>
<hr align="left"/>
<?php 
	...
	$sql="SELECT * FROM KnvandSpoons WHERE subC='ksp2'";
...
<div style='float:left;'><img src='$img' style='border-radius:30px;' width='250px' height='300px'/></div>
  ...
  <a href='myKnvandsp.php'>&laquo;</a>
  <a  href='myKnvandsp.php'>1</a>
  <a class='active' href='myKnvandsp2.php'>2</a>
</div>";
?>
</body>
</html>
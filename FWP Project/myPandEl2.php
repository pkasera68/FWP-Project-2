...
</br></br></br></br><span style='color:black; font-family:Impact,Charcoal,sans-serif; font-weight:bold; font-size:45px; '> Electronics and Kitchen Appliances.</span>
<hr align="left"/>
<?php 
	...
	$sql="SELECT * FROM PandEl WHERE subC='El'";
...
<div style='float:left;'><img src='$img' style='border-radius:30px;' width='250px' height='300px'/></div>
  ...
  <a  href='myPandEl.php'>1</a>
  <a class='active' href='myPandEl2.php'>2</a>
</div>";
?>

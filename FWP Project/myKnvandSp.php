...
<?php 
	...
	$sql="SELECT * FROM KnvandSpoons WHERE subC='ksp1'";
...
<div style='float:left;'><img src='$img' style='border-radius:30px;' width='250px' height='300px'/></div>
  ...
  <a href=''>&laquo;</a>
  <a class='active' href='myKnvandsp.php'>1</a>
  <a  href='myKnvandsp2.php'>2</a>
  <a href='myKnvandsp2.php'>&raquo;</a>
</div>";
?>
</body>
</html>
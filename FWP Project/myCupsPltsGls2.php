...
</br></br></br></br><span style='color:black; font-family:Impact,Charcoal,sans-serif; font-weight:bold; font-size:45px; '>Cups Plates And Glasses (Crockery).</span>
<hr align="left"/>
<?php 
	...
	$sql="SELECT * FROM cupsplatesandglasses WHERE subC='cplglp2'";
...
<div style='float:left;'><img src='$img' style='border-radius:30px;' width='250px' height='300px'/></div>
  ...
  <a  href='myCupsPltsGls.php'>1</a>
  <a class='active' href='myCupsPltsGls2.php'>2</a>
</div>";
?>

<?php
    ...
    exit;
		...
		$_SESSION["prt"]='cupsplatesandglasses';
?>
<html style="background-color: #EAEDED">
<head>
<title>
		CupsPlatesGlasses</title>
...
</br></br></br></br><span style='color:black; font-family:Impact,Charcoal,sans-serif; font-weight:bold; font-size:45px; '>Cups Plates And Glasses (Stainless Steel).</span>
<hr align="left"/>
<?php 
	...
	$sql="SELECT * FROM cupsplatesandglasses WHERE subC='cplglp1'";
...
<div style='float:left;'><img src='$img' style='border-radius:30px;' width='250px' height='300px'/></div>
	...
	echo "</br></br><div class='pagination' width:300px; style='margin-left:500px;'>
  <a href='myCupsPltsGls.php'>&laquo;</a>
  <a class='active' href='myCupsPltsGls.php'>1</a>
  <a  href='myCupsPltsGls2.php'>2</a>
   <a href='myCupsPltsGls2.php'>&raquo;</a>
</div>";
?>
